...
var Preview = function (_React$Component) {
  ...
  Preview.prototype.componentDidUpdate = function componentDidUpdate(prevProps) {
    clearTimeout(this.t);

    if (this.props.code !== prevProps.code || this.context.playgroundCode) {
      this.executeCode();
    }
  };
  ...
  Preview.prototype.executeCode = function executeCode() {
    ...
    var _props = this.props,
        ...
        babelConfig = _props.babelConfig,
        scope = _props.scope;
